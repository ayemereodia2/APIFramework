...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Ayemere Odia" => "Odiadavid2@gmail.com" }
  # Or just: spec.author    = "Ayemere Odia"
  # spec.authors            = { "Ayemere Odia" => "Odiadavid2@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Ayemere Odia"
